				...
				try:
					...
					if inst.pgcode in (errorcodes.NOT_NULL_VIOLATION, errorcodes.FOREIGN_KEY_VIOLATION, errorcodes.RESTRICT_VIOLATION):
						...
						try:
							...
							pass
						netsvc.abort_response(1, _('Warring'), 'warning', msg)
					else:
						netsvc.abort_response(1, _('Warring'), 'warning', inst[0])
				except Exception:

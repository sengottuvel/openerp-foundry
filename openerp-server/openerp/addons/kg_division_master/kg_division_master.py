...
class kg_division_master(osv.osv):
	...
	_defaults = {
		...
		'company_id': lambda self,cr,uid,c: self.pool.get('res.company')._company_default_get(cr, uid, 'kg.division.master', context=c),
		'active': True,
		'state': 'draft',
	...
	def write(self, cr, uid, ids, vals, context=None):
		...
		return super(kg_division_master, self).write(cr, uid, ids, vals, context)

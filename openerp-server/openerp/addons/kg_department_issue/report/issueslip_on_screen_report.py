...
report_sxw.report_sxw('report.issueslip.on.screen.report','kg.department.issue','addons/kg_department_issue/report/issueslip_on_screen_report.rml',parser=issueslip_on_screen_report,header=False)

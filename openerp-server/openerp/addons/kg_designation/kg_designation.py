...
class kg_designation(osv.osv):
	...
	def write(self, cr, uid, ids, vals, context=None):
		...
		return super(kg_designation, self).write(cr, uid, ids, vals, context)
	...
	def send_to_dms(self,cr,uid,ids,context=None):
		...
		url = 'http://192.168.1.7/sam-dms/login.html?xmxyypzr='+encoded_user+'&mxxrqx='+encoded_pwd+'&designation='+rec_code

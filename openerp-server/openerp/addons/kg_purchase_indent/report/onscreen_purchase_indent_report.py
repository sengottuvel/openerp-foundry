...
class onscreen_purchase_indent_report(JasperDataParser.JasperDataParser):
	
	def __init__(self, cr, uid, ids, data, context):
		
		super(onscreen_purchase_indent_report, self).__init__(cr, uid, ids, data, context)
...
jasper_report.report_jasper('report.onscreen_purchase_indent_report', 'purchase.requisition', parser=onscreen_purchase_indent_report)

...
class jasper_stock_inspection_report_print(JasperDataParser.JasperDataParser):
	def __init__(self, cr, uid, ids, data, context):		
		super(jasper_stock_inspection_report_print, self).__init__(cr, uid, ids, data, context)
...
jasper_report.report_jasper('report.jasper_stock_inspection_report', 'kg.stock.inspection', parser=jasper_stock_inspection_report_print, )

...
class jasper_purchase_list_report_print(JasperDataParser.JasperDataParser):
	def __init__(self, cr, uid, ids, data, context):		
		super(jasper_purchase_list_report_print, self).__init__(cr, uid, ids, data, context)
...
jasper_report.report_jasper('report.jasper_purchase_list_report', 'kg.purchase.list.print', parser=jasper_purchase_list_report_print, )

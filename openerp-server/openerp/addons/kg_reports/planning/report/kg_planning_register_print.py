...
class jasper_planning_register_report_print(JasperDataParser.JasperDataParser):
	def __init__(self, cr, uid, ids, data, context):		
		super(jasper_planning_register_report_print, self).__init__(cr, uid, ids, data, context)

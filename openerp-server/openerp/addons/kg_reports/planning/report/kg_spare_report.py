...
class jasper_spare_report_print(JasperDataParser.JasperDataParser):
	def __init__(self, cr, uid, ids, data, context):		
		super(jasper_spare_report_print, self).__init__(cr, uid, ids, data, context)
...
jasper_report.report_jasper('report.jasper_spare_report', 'kg.workorder.report', parser=jasper_spare_report_print, )

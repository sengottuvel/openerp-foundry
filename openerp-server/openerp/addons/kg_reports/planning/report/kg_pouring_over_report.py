...
class jasper_pouring_over_report_print(JasperDataParser.JasperDataParser):
	def __init__(self, cr, uid, ids, data, context):		
		super(jasper_pouring_over_report_print, self).__init__(cr, uid, ids, data, context)
...
jasper_report.report_jasper('report.jasper_pouring_over_report', 'kg.pouring.over', parser=jasper_pouring_over_report_print, )

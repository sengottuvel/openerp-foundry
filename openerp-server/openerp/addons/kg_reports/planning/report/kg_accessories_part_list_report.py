...
class jasper_accessories_part_list_report_print(JasperDataParser.JasperDataParser):
	def __init__(self, cr, uid, ids, data, context):		
		super(jasper_accessories_part_list_report_print, self).__init__(cr, uid, ids, data, context)
...
jasper_report.report_jasper('report.jasper_accessories_part_list_report', 'kg.accessories.list.print', parser=jasper_accessories_part_list_report_print, )

...
class jasper_foundry_partlist_report_print(JasperDataParser.JasperDataParser):
	def __init__(self, cr, uid, ids, data, context):		
		super(jasper_foundry_partlist_report_print, self).__init__(cr, uid, ids, data, context)
...
jasper_report.report_jasper('report.jasper_foundry_partlist_report', 'kg.foundry.partlist.print', parser=jasper_foundry_partlist_report_print, )

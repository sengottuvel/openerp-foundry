...
class jasper_drawing_sc_report_print(JasperDataParser.JasperDataParser):
	def __init__(self, cr, uid, ids, data, context):		
		super(jasper_drawing_sc_report_print, self).__init__(cr, uid, ids, data, context)
...
jasper_report.report_jasper('report.jasper_drawing_sc_report', 'kg.drawing.sc.print', parser=jasper_drawing_sc_report_print, )

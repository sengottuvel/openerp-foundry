...
class jasper_schedule_register_report_print(JasperDataParser.JasperDataParser):
	def __init__(self, cr, uid, ids, data, context):		
		super(jasper_schedule_register_report_print, self).__init__(cr, uid, ids, data, context)
...
jasper_report.report_jasper('report.jasper_schedule_register_report', 'kg.schedule.register', parser=jasper_schedule_register_report_print, )

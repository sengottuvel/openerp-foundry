...
class kg_production_register(osv.osv_memory):
	_name = "kg.production.register"
	_description = "Production Register"
	...
	_defaults = {
		...
		'company_id': lambda self,cr,uid,c: self.pool.get('res.company')._company_default_get(cr, uid, 'kg.production.register', context=c),
	 }
	...
	def create_report(self, cr, uid, ids, context={}):	
		...
		return {
			...
			'report_name'   : 'jasper_production_register_report',
			'datas': {

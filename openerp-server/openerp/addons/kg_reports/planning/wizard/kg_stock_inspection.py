...
class kg_stock_inspection(osv.osv_memory):
	_name = "kg.stock.inspection"
	...
	_defaults = {
		...
		'company_id': lambda self,cr,uid,c: self.pool.get('res.company')._company_default_get(cr, uid, 'kg.stock.inspection', context=c),
	 }
	...
	def create_report(self, cr, uid, ids, context={}):	
		...
		return {
			...
			'report_name'   : 'jasper_stock_inspection_report',
			'datas': {

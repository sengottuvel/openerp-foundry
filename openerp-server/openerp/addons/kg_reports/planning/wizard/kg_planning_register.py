...
class kg_planning_register(osv.osv_memory):
	_name = "kg.planning.register"
	_description = "Planning Register"
	...
	_defaults = {
		...
		'company_id': lambda self,cr,uid,c: self.pool.get('res.company')._company_default_get(cr, uid, 'kg.planning.register', context=c),
	 }
	...
	def create_report(self, cr, uid, ids, context={}):	
		...
		return {
			...
			'report_name'   : 'jasper_planning_register_report',
			'datas': {

...
class kg_allotted_components(osv.osv_memory):
	_name = "kg.allotted.components"
	_description = "Allotted Components"
	...
	_defaults = {
		...
		'company_id': lambda self,cr,uid,c: self.pool.get('res.company')._company_default_get(cr, uid, 'kg.allotted.components', context=c),
	 }
	...
	def create_report(self, cr, uid, ids, context={}):	
		...
		return {
			...
			'report_name'   : 'jasper_allotted_components_report',
			'datas': {

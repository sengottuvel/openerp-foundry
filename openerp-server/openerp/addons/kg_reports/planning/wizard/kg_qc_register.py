...
class kg_qc_register(osv.osv_memory):
	_name = "kg.qc.register"
	_description = "QC Register"
	...
	_defaults = {
		...
		'company_id': lambda self,cr,uid,c: self.pool.get('res.company')._company_default_get(cr, uid, 'kg.qc.register', context=c),
	 }
	...
	def create_report(self, cr, uid, ids, context={}):	
		...
		return {
			...
			'report_name'   : 'jasper_qc_register_report',
			'datas': {

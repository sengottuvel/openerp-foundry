...
class kg_excel_permission_report(osv.osv):

	_name = 'kg.excel.permission.report'
	...
	def produce_xls(self, cr, uid, ids, context={}):
		...
		sql = """		
			...
			and leaves.holiday_status_id = 29 """
		...
		sheet1 = wbk.add_sheet('PERMISSION_REPORT')
		s2=6
		...
		sheet1.write_merge(0, 3, 0, 7,"SAM TURBO INDUSTRY PRIVATE LIMITED \n Avinashi Road, Neelambur,\n Coimbatore - 641062 \n Tel:3053555, 3053556,Fax : 0422-3053535",style2)
		sheet1.row(0).height = 450
		sheet1.write_merge(4, 4, 0, 7,"PERMISSION REPORT FOR THE PERIOD "+ date_from + " "+ "TO "+date_to,style1)
		sheet1.write_merge(5, 5, 0, 7,"",style2)

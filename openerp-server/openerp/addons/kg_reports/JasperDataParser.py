...
#        }
    ...
    def get(self, parameter, default_value):
        ...
        elif parameter == 'testrecords':
            return hasattr(self, 'generate_testrecords') and \
                 self.generate_testrecords(self.cr, self.uid, self.ids, self.data, self.context) or default_value

...
class onscreen_spare_regular_report(JasperDataParser.JasperDataParser):
	def __init__(self, cr, uid, ids, data, context):
		
		super(onscreen_spare_regular_report, self).__init__(cr, uid, ids, data, context)
...
jasper_report.report_jasper('report.onscreen_spare_regular_report', 'kg.crm.offer', parser=onscreen_spare_regular_report)

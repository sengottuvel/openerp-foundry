...
class kg_so_bill_register_wiz(osv.osv_memory):
		
	_name = 'kg.so.bill.register.wiz'
	_columns = {
	...
	def _print_report(self, cr, uid, ids, data, context=None):
		...
		if data['form']:
			...
			return {'type': 'ir.actions.report.xml', 'report_name': 'kg.so.bill.register', 'datas': data,  'name': 'SO Bill Register'}
	
	
		

kg_so_bill_register_wiz()

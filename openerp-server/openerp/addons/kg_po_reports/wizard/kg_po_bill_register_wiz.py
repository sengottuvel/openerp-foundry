...
class kg_po_bill_register_wiz(osv.osv_memory):
		
	_name = 'kg.po.bill.register.wiz'
	_columns = {
	...
	def _print_report(self, cr, uid, ids, data, context=None):
		...
		if data['form']:
			...
			return {'type': 'ir.actions.report.xml', 'report_name': 'kg.po.bill.register', 'datas': data,  'name': 'PO Bill Register'}
	
	
		

kg_po_bill_register_wiz()

...
class onscreen_credit_note_print(JasperDataParser.JasperDataParser):
	
	def __init__(self, cr, uid, ids, data, context):
		super(onscreen_credit_note_print, self).__init__(cr, uid, ids, data, context)
...
jasper_report.report_jasper('report.onscreen_credit_note_print', 'kg.sale.cr.note', parser=onscreen_credit_note_print)

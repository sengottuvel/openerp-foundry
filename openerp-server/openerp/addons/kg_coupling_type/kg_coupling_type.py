...
class kg_coupling_type(osv.osv):
	
	_name = "kg.coupling.type"
	_description = "Coupling Type Master"
	...
	_defaults = {
		...
		'company_id': lambda self,cr,uid,c: self.pool.get('res.company')._company_default_get(cr, uid, 'kg.coupling.type', context=c),
		'active': True,
		'state': 'draft',
	...
	def entry_reject(self,cr,uid,ids,context=None):
		...
		if rec.state == 'confirmed':
			if rec.remark:
				...
				raise osv.except_osv(_('Rejection remark is must !!'),_('Enter the remarks in rejection remark field !!'))
		else:
			pass
		return True
	...
	def write(self, cr, uid, ids, vals, context=None):
		...
		return super(kg_coupling_type, self).write(cr, uid, ids, vals, context)	

...
class onscreen_proforma_invoice_report(JasperDataParser.JasperDataParser):
	def __init__(self, cr, uid, ids, data, context):
		
		super(onscreen_proforma_invoice_report, self).__init__(cr, uid, ids, data, context)
...
jasper_report.report_jasper('report.onscreen_proforma_invoice_report', 'purchase.order', parser=onscreen_proforma_invoice_report)

...
class onscreen_dc_print_report(JasperDataParser.JasperDataParser):
	def __init__(self, cr, uid, ids, data, context):
		
		super(onscreen_dc_print_report, self).__init__(cr, uid, ids, data, context)
...
jasper_report.report_jasper('report.onscreen_dc_print_report', 'purchase.order', parser=onscreen_dc_print_report)

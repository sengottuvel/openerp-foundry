...
class onscreen_custom_cheque_print(JasperDataParser.JasperDataParser):
	def __init__(self, cr, uid, ids, data, context):
		
		super(onscreen_custom_cheque_print, self).__init__(cr, uid, ids, data, context)
...
jasper_report.report_jasper('report.onscreen_custom_cheque_print', 'account.voucher', parser=onscreen_custom_cheque_print)

...
class kg_product_reg_wizard(osv.osv_memory):
		
	_name = 'kg.product.reg.wizard'
	_columns = {
		...
		'product':fields.many2many('product.product','product_register','product_wiz_id','product_id','Product'),
	...
	_defaults = {
		...
		'company_id': lambda self,cr,uid,c: self.pool.get('res.company')._company_default_get(cr, uid, 'kg.product.reg.wizard', context=c),
	...
	def _print_report(self, cr, uid, ids, data, context=None):
		...
		if data['form']:
			...
			if data['form']['type'] == 'consu':
				data['form']['type_name'] = 'Consumable Goods - '
			
			elif data['form']['type'] == 'service':
				data['form']['type_name'] = 'Service Goods - '
				
			elif data['form']['type'] == 'cap':
				data['form']['type_name'] = 'Capital Goods - '
			elif data['form']['type'] == 'assets':
				data['form']['type_name'] = 'Assests - '	
			...
			return {'type': 'ir.actions.report.xml', 'report_name': 'kg.product.reg.report', 'datas': data, 'name': 'Product_Register'}

kg_product_reg_wizard()

...
class kg_product_warranty_wiz(osv.osv_memory):
		
	_name = 'kg.product.warranty.wiz'
	_columns = {
		...
		'status': fields.selection([('approved', 'Approved'),('cancelled','Cancelled'),('pending','Pending')], "Status",invisible=True),
	...
	def _print_report(self, cr, uid, ids, data, context=None):
		...
		if data['form']:
			...
			return {'type': 'ir.actions.report.xml', 'report_name': 'kg.product.warranty.register', 'datas': data,  'name': 'PO Register'}
	
	
		

kg_product_warranty_wiz()

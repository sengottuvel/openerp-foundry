...
class kg_depindent_detail_report(report_sxw.rml_parse):
	...
	def get_data(self,form):
		...
		self.cr.execute('''
				...
				to_char(indent.ind_date,'dd/mm/yyyy') as indent_date,
				...
				where indent.ind_date >=%s and indent.ind_date <=%s and indent.state = %s '''+ where_sql + '''
				order by indent.ind_date ''',(form['date_from'],form['date_to'],ind_state))

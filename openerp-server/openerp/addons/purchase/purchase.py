...
class purchase_order(osv.osv):
	...
	def _set_minimum_planned_date(self, cr, uid, ids, name, value, arg, context=None):
		print "_set_minimum_planned_date called from PPPPPPPPOOOOOOOOOOOOOOO"
	...
	def _minimum_planned_date(self, cr, uid, ids, field_name, arg, context=None):
		print "_minimum_planned_date called from PPPPPPPPOOOOOOOOOOOOOOO"
		res={}
	...
	"""
	Create method commanded by sengottuvel
	...
	def wkf_send_rfq(self, cr, uid, ids, context=None):
		...
		try:
			...
			print "template_id__________________________", template_id
		except ValueError:
			template_id = False
		try:
			compose_form_id = ir_model_data.get_object_reference(cr, uid, 'mail', 'email_compose_message_wizard_form')[1]
			print "compose_form_id__________________________", compose_form_id
		except ValueError:
...
class purchase_order_line(osv.osv):
	...
	def _get_date_planned(self, cr, uid, supplier_info, date_order_str, context=None):
		print "_get_date_planned from Openerp<><><><><><><><>"
	...
	def _check_product_uom_group(self, cr, uid, context=None):
		print "_check_product_uom_group from Openerp<><><><><><><><>"
	...
	def onchange_product_id(self, cr, uid, ids, pricelist_id, product_id, qty, uom_id,
		...
		product_po_copy_uom = product.po_copy_uom.id
		if product_po_copy_uom:
			po_copy_uom_id = product_po_copy_uom
		else:
			po_copy_uom_id = ''
		if not uom_id:

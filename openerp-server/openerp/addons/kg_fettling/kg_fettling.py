...
class kg_fettling(osv.osv):
	...
	_columns = {
		...
		'knockout_shift_id':fields.many2one('kg.shift.master','Shift', required=True),
		'knockout_contractor':fields.many2one('kg.contractor.master','Contractor', required=True),
		'knockout_qty': fields.integer('Total Qty', required=True),
		'knockout_accept_qty': fields.integer('Accepted Qty', required=True),
		'knockout_reject_qty': fields.integer('Rejected Qty', required=True),
		...
		'decoring_shift_id':fields.many2one('kg.shift.master','Shift', required=True),
		'decoring_contractor':fields.many2one('kg.contractor.master','Contractor', required=True),
		'decoring_qty': fields.integer('Total Qty', required=True),
		'decoring_accept_qty': fields.integer('Accepted Qty', required=True),
		'decoring_reject_qty': fields.integer('Rejected Qty', required=True),
		...
		'shot_blast_shift_id':fields.many2one('kg.shift.master','Shift', required=True),
		'shot_blast_contractor':fields.many2one('kg.contractor.master','Contractor', required=True),
		'shot_blast_qty': fields.integer('Total Qty', required=True),
		'shot_blast_accept_qty': fields.integer('Accepted Qty', required=True),
		'shot_blast_reject_qty': fields.integer('Rejected Qty', required=True),
		...
		'hammering_shift_id':fields.many2one('kg.shift.master','Shift', required=True),
		'hammering_contractor':fields.many2one('kg.contractor.master','Contractor', required=True),
		'hammering_qty': fields.integer('Total Qty', required=True),
		'hammering_accept_qty': fields.integer('Accepted Qty', required=True),
		'hammering_reject_qty': fields.integer('Rejected Qty', required=True),
		...
		'wheel_cutting_shift_id':fields.many2one('kg.shift.master','Shift', required=True),
		'wheel_cutting_contractor':fields.many2one('kg.contractor.master','Contractor', required=True),
		'wheel_cutting_qty': fields.integer('Total Qty', required=True),
		'wheel_cutting_accept_qty': fields.integer('Accepted Qty', required=True),
		'wheel_cutting_reject_qty': fields.integer('Rejected Qty', required=True),
		...
		'gas_cutting_shift_id':fields.many2one('kg.shift.master','Shift', required=True),
		'gas_cutting_contractor':fields.many2one('kg.contractor.master','Contractor', required=True),
		'gas_cutting_qty': fields.integer('Total Qty', required=True),
		'gas_cutting_accept_qty': fields.integer('Accepted Qty', required=True),
		'gas_cutting_reject_qty': fields.integer('Rejected Qty', required=True),
		...
		'arc_cutting_shift_id':fields.many2one('kg.shift.master','Shift', required=True),
		'arc_cutting_contractor':fields.many2one('kg.contractor.master','Contractor', required=True),
		'arc_cutting_qty': fields.integer('Total Qty', required=True),
		'arc_cutting_accept_qty': fields.integer('Accepted Qty', required=True),
		'arc_cutting_reject_qty': fields.integer('Rejected Qty', required=True),
		...
		'heat_total_qty': fields.integer('Total Qty', required=True),
		'heat_qty':fields.integer('Qty', required=True),
		'heat_each_weight':fields.integer('Each Weight', required=True),
		'heat_total_weight':fields.integer('Total Weight', required=True),
		...
		'rough_grinding_shift_id':fields.many2one('kg.shift.master','Shift', required=True),
		'rough_grinding_contractor':fields.many2one('kg.contractor.master','Contractor', required=True),
		'rough_grinding_qty': fields.integer('Total Qty', required=True),
		'rough_grinding_accept_qty': fields.integer('Accepted Qty', required=True),
		'rough_grinding_reject_qty': fields.integer('Rejected Qty', required=True),
		...
		'finish_grinding_shift_id':fields.many2one('kg.shift.master','Shift', required=True),
		'finish_grinding_contractor':fields.many2one('kg.contractor.master','Contractor', required=True),
		'finish_grinding_qty': fields.integer('Total Qty', required=True),
		'finish_grinding_accept_qty': fields.integer('Accepted Qty', required=True),
		'finish_grinding_reject_qty': fields.integer('Rejected Qty', required=True),

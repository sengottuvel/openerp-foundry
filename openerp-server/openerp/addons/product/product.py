...
class product_template(osv.osv):
	...
	_columns = {
		...
		'type': fields.selection([('consu', 'Consumable'),('service','Service')], 'Product Type', required=False, help="Consumable are product where you don't manage stock, a service is a non-material product provided by a company or an individual."),
		#'type': fields.selection([('raw','Foundry Raw Materials'),('ms','MS Item'),('bot','BOT'),('consu', 'Consumable'),('capital','Capitals and Asset'),('service','Service')], 'Product Type', required=True, help="Consumable are product where you don't manage stock, a service is a non-material product provided by a company or an individual."),
...
class product_product(osv.osv):
	...
	_columns = {
		...
		'state': fields.selection([('draft','Draft'),('confirm','WFA'),('approved','Approved'),('cancel','Cancelled'),

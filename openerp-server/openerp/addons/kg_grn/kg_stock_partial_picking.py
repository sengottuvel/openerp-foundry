		...
		for wizard_line in partial.move_ids:
			...
			if move_record.move_type == 'in' and move_record.purchase_line_id:
				...
				if move_record.exp_line_id:
					...
					for exp in move_record.exp_line_id:
						print "exp................................",exp
						print "exp................................",exp.product_qty
						
						exp_product_qty = exp.product_qty * move_record.product_id.po_uom_coeff
						...
						lot_obj.create(cr,uid,
							...
							'product_qty':exp_product_qty,
							'pending_qty':exp_product_qty,
							'issue_qty':exp_product_qty,

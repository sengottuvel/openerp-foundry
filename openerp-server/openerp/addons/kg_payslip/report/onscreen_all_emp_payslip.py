...
class onscreen_all_emp_payslip(report_sxw.rml_parse):
	
	_name = 'onscreen.all.emp.payslip'
	   

	def __init__(self, cr, uid, name, context=None):
		if context is None:
			context = {}
		super(onscreen_all_emp_payslip, self).__init__(cr, uid, name, context=context)
		self.query = ""
		self.period_sql = ""
		...
		self.cr.execute('''
					SELECT
								...
								and pay.state= 'done'
								 ...
								 ''',(form['form']['date_start'],form['form']['date_end'],form['form']['date_start'],form['form']['date_end']))
...
report_sxw.report_sxw('report.onscreen.all.emp.payslip', 'hr.payslip', 
			'addons/kg_payslip/report/onscreen_all_emp_payslip.rml', 
			parser=onscreen_all_emp_payslip, header = False)

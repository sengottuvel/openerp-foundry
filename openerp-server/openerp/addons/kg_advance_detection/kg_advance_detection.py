...
class kg_advance_detection(osv.osv):

	_name = "kg.advance.detection"
	...
	def write(self, cr, uid, ids, vals, context=None):
		...
		return super(kg_advance_detection, self).write(cr, uid, ids, vals, context)
	...
	def _duplicate_validation(self, cr, uid, ids, context=None):
		ded_obj = self.pool.get('kg.advance.detection')
